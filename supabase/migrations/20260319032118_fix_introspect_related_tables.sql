/*
  # Fix introspect_table_schema relatedTables field

  - relatedTables now returns an array of table name strings instead of FK objects
  - Extracts referencesTable from each foreign key
*/
