          ...
          <div className="space-y-1.5">
            {availableCategories.map(cat => (
              <button
                ...
                style={{
                  background: targetId === cat.id ? 'rgba(245,158,11,0.12)' : 'rgba(30,41,59,0.6)',
                  border: targetId === cat.id ? '1px solid rgba(245,158,11,0.3)' : '1px solid rgba(51,65,85,0.4)',
                  color: targetId === cat.id ? '#f59e0b' : '#cbd5e1',
                }}
              >
                {cat.name}
              </button>
