...
import type { TestCategoryItem } from './SATestTranslationModal';
import { useThemeTokens } from '../../../../hooks/useThemeTokens';

interface Props {
  open: boolean;
  initial: TestCategoryItem | null;
  onSave: (entry: TestCategoryItem) => void;
  onClose: () => void;
}

export default function SATestCategoryModal({ open, initial, onSave, onClose }: Props) {
      ...
      >
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-base font-bold text-slate-100">
            {initial ? 'Modifier la categorie' : 'Creer une categorie'}
          </h2>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Exemple : Page d'accueil"
