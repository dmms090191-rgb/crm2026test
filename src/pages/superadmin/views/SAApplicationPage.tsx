...
import { Smartphone, Download, ImagePlus, CheckCircle2, Share, Plus, MoreVertical } from 'lucide-react';
  ...
  if (pwa.state === 'ios-manual') {
    return (
      <div className="flex flex-col items-center gap-3">
        ...
        {showHelp && (
          <ManualInstallHelp t={t} variant="ios" />
        )}
      </div>
    );
  }

  if (pwa.state === 'android-manual') {
    return (
      <div className="flex flex-col items-center gap-3">
        <button
          onClick={() => setShowHelp(!showHelp)}
        ...
        {showHelp && (
          <ManualInstallHelp t={t} variant="android" />
        )}
      </div>
    );
  }
