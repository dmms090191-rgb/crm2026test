...
export default function AdminDetailCommentsTab({ adminId }: Props) {
  ...
  async function addComment() {
    ...
    setLoading(true);
    await supabase.from('admin_comments').insert({ admin_id: adminId, content: newComment.trim() });
    setNewComment('');
    await fetchComments();
    setLoading(false);
  }
  ...
  async function deleteSelected() {
    ...
    await supabase.from('admin_comments').delete().in('id', Array.from(selected));
    setSelected(new Set());
    await fetchComments();
  }
