...
function AdminDashboardInner({ onLogout, onConnectAsVendor, onConnectAsClient, impersonatedAdmin, onBackToSuperAdmin, backLabel, isSAViewing, visuBadgeLabel }: AdminDashboardProps) {
