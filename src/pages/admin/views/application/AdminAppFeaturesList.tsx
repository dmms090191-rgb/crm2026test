...
const features = [
  ...
  { label: 'Messagerie', desc: 'Communication avec vos equipes', color: '#f59e0b' },
  { label: 'Notifications push', desc: 'Alertes instantanees sur mobile', color: '#ef4444' },
  { label: 'Agenda', desc: 'Planification et rappels de RDV', color: '#06b6d4' },
...
export default function AdminAppFeaturesList({ appIconUrl, appName, onChangeAppIcon }: Props) {
    ...
    <div className="flex flex-col items-center text-center">
      ...
      <div className="relative mb-4">
        ...
        {appIconUrl ? (
          ...
          >
            <span className="text-white text-4xl sm:text-5xl font-bold select-none">{initial}</span>
          </div>
        )}
      </div>
      ...
      <h3 className="text-lg font-bold mb-1" style={{ color: t.heading.primary }}>{appName}</h3>
      <p className="text-xs mb-1" style={{ color: t.text.tertiary }}>Application de votre societe</p>
      <p
