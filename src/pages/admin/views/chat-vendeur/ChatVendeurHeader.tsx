...
export default function ChatVendeurHeader({ tokens }: Props) {
  return (
    <div className="flex items-center justify-between flex-shrink-0">
      <div>
        <h2 className="text-base md:text-xl font-bold" style={{ color: tokens.text.primary }}>Chat Commercial</h2>
        <p className="text-[11px] md:text-xs mt-0.5 hidden sm:block" style={{ color: tokens.text.quaternary }}>Chat avec vos commerciaux</p>
      </div>
      <div
