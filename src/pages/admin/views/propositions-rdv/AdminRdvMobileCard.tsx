import { CalendarDays, Clock, Phone, Mail, Users, Pencil, XCircle, CheckCircle, ArrowUpRight } from 'lucide-react';
...
export default function AdminRdvMobileCard({ rdv, timezone, selected, vendorName: vName, onToggleSelect, onAccept, onCancel, onEdit, onDetail, onGoToLead }: Props) {
