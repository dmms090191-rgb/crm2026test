import { CalendarDays, Clock, Phone, Mail, Users, Pencil, CheckCircle, XCircle } from 'lucide-react';
...
export default function AdminRdvMobileCard({ rdv, timezone, selected, vendorName: vName, onToggleSelect, onAccept, onRefuse, onEdit, onDetail }: Props) {
