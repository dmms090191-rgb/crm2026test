...
import { formatRelativeTime, ConfirmedProposalItem, AgendaEquipeNotifItem } from './NotificationItems';
export { ConfirmedProposalItem, AgendaEquipeNotifItem };
...
export function ProposalNotifItem({
  entry,
  tokens,
  onClick,
}: {
