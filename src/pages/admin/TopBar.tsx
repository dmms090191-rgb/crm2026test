...
export default function TopBar({ breadcrumb, adminName = 'Administrateur' }: TopBarProps) {
  return (
    <header
    ...
    >
      ...
      <div className="flex items-center gap-1">
        {[
          ...
          { label: 'Chat vendeur', icon: <MessageCircle className="w-3.5 h-3.5" /> },
        ...
        >
          ...
          <div className="hidden lg:block">
            ...
            <p className="text-[9px] text-slate-600 tracking-wider uppercase">Super Admin</p>
          </div>
        </div>
      </div>
    </header>
