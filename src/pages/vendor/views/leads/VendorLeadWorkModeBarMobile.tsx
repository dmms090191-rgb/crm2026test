...
export default function VendorLeadWorkModeBarMobile({
  ...
  onLocate, canLocate, onReset, onOpenColumns, onOpenOrganize,
  columnsLocked, showToast, inactiveBtn, t,
}: Props) {
  return (
    <div className="flex md:hidden flex-col gap-2.5" style={{ background: t.card.bg, borderRadius: 12, padding: '10px 12px' }}>
      ...
      <div className="flex items-center gap-2">
        {columnsLocked ? (
          <div className="inline-flex items-center gap-1.5 h-9 px-3 rounded-lg text-xs font-semibold" style={{ background: t.surface.secondary, border: `1px solid ${t.surface.border}`, color: t.text.quaternary, opacity: 0.6 }}>
