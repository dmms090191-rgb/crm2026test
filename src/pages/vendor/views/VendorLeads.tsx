...
interface DetailModalProps {
  ...
  onConnect: (client: ImpersonatedClientInfo) => void;
}

function DetailModal({ lead, gradIndex, onClose, statutDefs, onConnect }: DetailModalProps) {
    ...
    >
      ...
      >
        ...
        <div className="px-6 pb-6">
          <button
            onClick={() => onConnect({ id: lead.id, nom, prenom, email })}
...
export default function VendorLeads({ vendorId, onOpenChat, onConnectAsClient }: VendorLeadsProps) {
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 text-xs mt-0.5">Leads qui vous sont attribués</p>
        </div>
      ...
      <div className="rounded-2xl overflow-hidden" style={cardStyle}>
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-3">
            ...
            <p className="text-slate-600 text-sm">Aucun lead attribué</p>
            <p className="text-slate-700 text-xs">L'administrateur peut vous attribuer des leads depuis le CRM</p>
          </div>
        ) : (
          <>
                  ...
                  {filtered.map((lead, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5" style={colSep}>
                          <div className="flex items-center gap-2.5">
                            <div className="w-7 h-7 rounded-lg flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0" style={{ background: grad, boxShadow: '0 2px 6px rgba(0,0,0,0.3)' }}>
                              {initials || '?'}
                            </div>
