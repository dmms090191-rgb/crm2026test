...
import CrmPinDisplay from '../../admin/views/crm/CrmPinDisplay';
import CrmCommentsTab from '../../admin/views/crm/CrmCommentsTab';

type TabId = 'commentaires' | 'mot-de-passe';
...
export default function VendorLeadDetailModal({ lead, gradIndex, onClose, statutDefs, onConnect }: VendorLeadDetailModalProps) {
