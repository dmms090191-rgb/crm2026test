...
export function VendorDropdownPanel({ tokens, width, align, children }: { tokens: ThemeTokens; width: string; align: 'left' | 'right'; children: React.ReactNode }) {
  return (
    <div
...
export function VendorDropdownHeader({ label, tokens }: { label: string; tokens: ThemeTokens }) {
  return (
...
export function VendorDropdownEmpty({ text, tokens }: { text: string; tokens: ThemeTokens }) {
  return (
